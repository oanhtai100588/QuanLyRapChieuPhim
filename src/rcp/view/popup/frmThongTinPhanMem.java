...
public class frmThongTinPhanMem extends Shell {
	...
	public frmThongTinPhanMem(Display display) {
		...
		lblNewLabel.setText("Đồ án Java");
		...
		lblH.setText("14520783 - Lê Văn Tài");
		...
		lblHunh.setText("14520660 - Nguyễn Minh Phát");
